...
// Environment variables configuration using Next.js process.env
...
// Safe window-check for SSR compatibility during Next build
const getStoredMockUser = () => {
  if (typeof window !== 'undefined') {
    return localStorage.getItem('sleepora_mock_user');
  }
  return null;
};
...
// Clean Professional Error Mapper
