...
export default function Cart() {
  ...
  const handleQtyChange = (item, diff) => {
    updateCartQty(item.product_id, item.variant_id, item.quantity + diff);
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            return (
              ...
              >
                <div className="flex gap-4 items-center">
                  {/* Thumbnail */}
                  <Link href={`/product/${item.product_id}`} className="w-20 h-20 bg-dreamBlush rounded-premium overflow-hidden shrink-0 border border-dreamBorder">
                    <img 
                  ...
                  <div className="space-y-1">
                    <Link href={`/product/${item.product_id}`} className="text-sm font-bold font-poppins text-dreamNavy hover:text-dreamAccent transition-colors line-clamp-1">
                      {item.name}
                    </Link>
          ...
          <div className="pt-4">
            <Link href="/shop" className="text-xs sm:text-sm font-bold text-dreamAccent flex items-center gap-2 hover:underline">
