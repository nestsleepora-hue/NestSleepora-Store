...
function OrderConfirmationContent() {
  ...
  if (error || !order) {
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center space-y-4 font-sans">
        ...
        <Link href="/" className="px-6 py-2 bg-dreamAccent text-white text-xs font-bold rounded-premium inline-block">
          Return to Home
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-12 space-y-8 text-left font-sans">
  ...
  return (
    <Suspense fallback={
      <div className="max-w-md mx-auto px-4 py-20 text-center space-y-4 font-sans animate-pulse">
        <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-dreamAccent mx-auto"></div>
        <p className="text-xs text-dreamMuted">Verifying checkout credentials...</p>
      </div>
    }>
