...
export default function Profile() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12 text-left font-sans">
        ...
        <ScrollReveal delay={200}>
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-dreamBorder pb-3">
              ...
              <Link href="/shop" className="text-xs font-bold text-dreamAccent hover:underline">Browse Products</Link>
            </div>
        ...
        <ScrollReveal delay={300}>
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-dreamBorder pb-3">
              ...
              <Link href="/cart" className="text-xs font-bold text-dreamAccent hover:underline">View Full Cart</Link>
            </div>
