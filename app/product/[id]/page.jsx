  ...
  if (error || !data) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center space-y-4">
        ...
        <Link href="/shop" className="inline-flex items-center gap-2 text-dreamAccent font-bold hover:underline">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-dreamMuted font-sans">
        ...
        <ChevronRight className="w-4 h-4 text-dreamBorder" />
        <Link href={`/shop/${product.category}`} className="hover:text-dreamAccent capitalize">{product.category}</Link>
        <ChevronRight className="w-4 h-4 text-dreamBorder" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-6 text-left">
          ...
          <p className="text-sm text-dreamNavy/70 leading-relaxed font-medium whitespace-pre-wrap">
            {product.description}
          </p>
      ...
      {/* Tabs row */}
      <div className="border-t border-dreamBorder pt-10 mt-6 font-sans">
                ...
                >
                  ...
                  <div className="p-4 flex-grow flex flex-col justify-between">
                    <div>
                      ...
                      <Link href={`/product/${p.id}`} className="text-sm font-bold font-poppins text-dreamNavy hover:text-dreamAccent transition-colors leading-snug line-clamp-1">
                        {p.name}
                      </Link>
                    </div>
